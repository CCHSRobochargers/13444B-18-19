...
#pragma config(Motor,  port2,           backright,     tmotorVex393_MC29, PIDControl, reversed, encoderPort, I2C_2)
#pragma config(Motor,  port3,           backleft,      tmotorVex393_MC29, PIDControl, encoderPort, I2C_1)
#pragma config(Motor,  port5,           forks,         tmotorVex393_MC29, PIDControl, encoderPort, I2C_4)
...
#pragma config(Motor,  port9,           rightarm,      tmotorVex393_MC29, PIDControl, encoderPort, I2C_3)
...
//setMotorTarget(leftarm, dist*ticksPerArmInch, speed, hold);
	...
	while (!getMotorTargetCompleted(rightarm))
		wait1Msec(10);
}
...
void red_close(void)
{
	move(-47, 127, false);		//(flag + platform)
	arm(5, 127, false);
	move(78, 127, false);
	spin(90, 127, false);
	move(55, 127, false);
